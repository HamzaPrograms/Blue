...
class MainActivity3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val launchButton = findViewById<Button>(R.id.buttonScan2)
        launchButton.setOnClickListener {
            ...
            serviceIntent.putExtra("com.termux.RUN_COMMAND_ARGUMENTS", arrayOf("-c", "nmap -A 192.168.0.0/24; exec bash"))
